...
// Llamado por Vercel Cron (GET) cada 12h — también acepta POST para llamadas manuales
...
// Vercel Cron llama con GET + Authorization: Bearer ${CRON_SECRET}
export async function GET(req: NextRequest) {
  return runTracking(req);
}
...
async function runTracking(req: NextRequest) {
