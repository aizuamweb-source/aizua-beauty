...
const T: Record<string, Record<string, string>> = {
  es: {
    title: "TIENDA",
    subtitle: "Belleza · Accesorios de mujer · Envío EU",
    all: "Todos",
    ...
    reviews: "reseñas",
    empty: "Pronto más productos — mientras tanto, lee nuestras guías de belleza ↗",
    back: "← Inicio",
    products: "productos",
  ...
  en: {
    title: "SHOP",
    subtitle: "Beauty · Women's accessories · EU shipping",
    all: "All",
    sort_new: "Newest",
    ...
    reviews: "reviews",
    empty: "More products coming soon — meanwhile, read our beauty guides ↗",
    back: "← Home",
    products: "products",
  ...
  fr: {
    title: "BOUTIQUE",
    subtitle: "Beauté · Accessoires femme · Livraison UE",
    all: "Tous",
    ...
    reviews: "avis",
    empty: "Plus de produits bientôt — découvrez nos guides de beauté ↗",
    back: "← Accueil",
    products: "produits",
    search: "Rechercher...",
  },
  de: {
    title: "SHOP",
    subtitle: "Beauty · Damen-Accessoires · EU-Versand",
    all: "Alle",
    sort_new: "Neueste",
    ...
    reviews: "Bewertungen",
    empty: "Bald mehr Produkte — entdecke unsere Beauty-Ratgeber ↗",
    back: "← Startseite",
    products: "Produkte",
    search: "Suchen...",
  },
  pt: {
    title: "LOJA",
    subtitle: "Beleza · Acessórios femininos · Envio EU",
    all: "Todos",
    ...
    reviews: "avaliações",
    empty: "Em breve mais produtos — descubra os nossos guias de beleza ↗",
    back: "← Início",
    products: "produtos",
    search: "Pesquisar...",
  },
  it: {
    title: "NEGOZIO",
    subtitle: "Bellezza · Accessori donna · Spedizione UE",
    all: "Tutti",
    ...
    reviews: "recensioni",
    empty: "Presto altri prodotti — scopri le nostre guide di bellezza ↗",
    back: "← Home",
    products: "prodotti",
    search: "Cerca...",
  },
      ...
      <div style={{ padding: "0 2.5rem 6rem", maxWidth: "1200px", margin: "0 auto" }}>
        {filtered.length === 0 ? (
          <div style={{ textAlign: "center", padding: "6rem 0", color: "#888", fontSize: "1rem" }}>
            ...
            <Link href={`/${locale}/blog`} style={{ display: "inline-block", background: "#7BA05B", color: "#fff", padding: "0.75rem 2rem", borderRadius: "8px", fontWeight: 700, fontSize: "0.875rem", textDecoration: "none", letterSpacing: "0.05em" }}>
