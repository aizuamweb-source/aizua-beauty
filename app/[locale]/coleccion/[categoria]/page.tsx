...
const CATEGORY_META: Record<string, Record<string, { title: string; desc: string; keywords: string[] }>> = {
  "skincare": {
    es: { title: "Crema Natural Ringana sin Parabenos", desc: "Cosmética Ringana FRESH: cremas hidratantes, sérums de vitamina C y tónicos sin conservantes ni parabenos. Formulados frescos. Envío gratis España y EU.", keywords: ["crema natural sin parabenos comprar", "Ringana FRESH skincare", "sérum vitamina C natural", "cosmética fresca sin conservantes", "crema hidratante vegana EU", "skincare natural sin parabenos España"] },
    en: { title: "Natural Ringana Skincare No Parabens", desc: "Ringana FRESH cosmetics: hydrating creams, vitamin C serums and tonics without preservatives or parabens. Freshly formulated. Free EU shipping.", keywords: ["natural skincare no parabens buy", "Ringana FRESH skincare EU", "vitamin C serum natural", "fresh cosmetics no preservatives", "vegan face cream EU"] },
  ...
  "perfumes": {
    es: { title: "Perfumes Naturales Ringana sin Ftalatos", desc: "Fragancias Ringana naturales: perfumes frescos sin alcohol sintético ni ftalatos. Sprays corporales y aceites formulados en Austria. Envío gratis EU.", keywords: ["perfume natural sin ftalatos comprar", "fragancia Ringana natural EU", "perfume vegano España", "spray corporal natural sin alcohol", "perfume orgánico EU comprar"] },
