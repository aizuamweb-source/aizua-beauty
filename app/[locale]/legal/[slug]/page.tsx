  ...
  return (
    <>
      ...
      <div style={S.box}>
        ...
        <p style={{ ...S.p, marginBottom: 0 }}><strong>Email:</strong> info@aizualabs.com</p>
      </div>
...
function DevolucionesContent() {
  return (
    <>
      ...
      <div style={S.warn}>
        <p style={{ ...S.p, marginBottom: 0, color: "#92400E" }}>⚠️ Aizua no amplía el plazo más allá del mínimo legal. Si tienes cualquier incidencia, contacta dentro de ese periodo a <strong>info@aizualabs.com</strong>.</p>
      </div>
      ...
      <p style={S.p}>Contacta en <strong>info@aizualabs.com</strong> en 48h desde la recepción, adjuntando fotos del producto y embalaje. Los gastos de devolución corren a nuestro cargo en este caso.</p>
...
function CookiesContent() {
  return (
    <>
      ...
      <p style={S.p}>Para cualquier consulta sobre el uso de cookies: <strong>info@aizualabs.com</strong></p>
    </>
  );
}
  ...
  return (
    <>
      ...
      <div style={S.box}>
        ...
        <p style={S.p}><strong>Email:</strong> info@aizualabs.com</p>
